...
-- [回答]
INSERT INTO goods_table (goods_code, goods_name, price, update_day) VALUES ('M001', 'マフラー', 4500, '2023-07-26');
 /***
SELECT * FROM goods_table WHERE goods_code = 'M001' AND goods_name = 'マフラー' AND price = 4500 AND update_day = '2023-07-26'
 ***/
 
-- 7. 在庫テーブルの商品コード='S987'、かつ、店舗コード='EA01'に対して、「在庫数=10、更新日付=本日日付」で更新しなさい。※実行後のSELECT結果も貼付すること。
-- [回答]
UPDATE stock_table SET quantity = 10, update_day = '2023-07-26' WHERE goods_code = 'S987' AND store_code = 'EA01'
